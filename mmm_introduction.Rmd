...
First, let's start with the simplest example where we have only a single marketing channel and a known relationship between marketing spend and revenue. Though not realistic, this will serve as a foundation for what follows. We will express the relationship between revenue and marketing spend as log-linear in the following way:
...
Let's now fit and evaluate our log-linear model:
```{r}
